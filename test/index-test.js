...
describe('Handling incremental publisher webhook events', function() {
  ...
  beforeEach(function() {
    ...
    simple.mock(IncrementalsPlugin.prototype, 'uploadToArtifactory', async () => { return {
      status: 200,
      statusText: 'Success'
    }; } );
    simple.mock(IncrementalsPlugin.prototype, 'fetch', asyncFetch);
    simple.mock(IncrementalsPlugin.prototype.permissions, 'fetch', async () => { return {
      status: 200,
  ...
  describe('success', function() {
    it('should claim all is a sucess', async function() {
      data.body.build_url = 'https://ci.jenkins.io/job/Tools/job/bom/job/PR-22/5/';
      await run();
